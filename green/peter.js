...
function Update(e)
{
    ...
    if(allowRender)
    {
        for(i = 0; i < numPoints; i++)
        {
            drawPoint(ctx, pointsArray[i], 700);
...
function drawPoint(ctx, point, size)
{
    ...
    var radgrad = ctx.createRadialGradient(point[0],point[1],0,point[0],point[1],size);
    radgrad.addColorStop(0, 'rgba(16, 23, 41, 1)');
    radgrad.addColorStop(0.4, 'rgba(18, 36, 48, 0.8)');
    radgrad.addColorStop(1, 'rgba(28, 62, 48, 0)');
